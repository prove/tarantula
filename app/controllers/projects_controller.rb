...
class ProjectsController < ApplicationController
  ...
  def show
    ...
    render :json => "{\"data\":[#{@project.to_data.as_json}]}"
  end
  ...
  def priorities
    render :json => "{\"data\": #{Project::Priorities.as_json}}"
  end
  ...
  def products
    ...
    render :json => "{\"data\": #{products.map(&:to_data).as_json}}"
  end
